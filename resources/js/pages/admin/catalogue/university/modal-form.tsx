...
type ModalFormUniversityProps = { name: string; alias: string; id: number | null };

export const ModalFormUniversity = ({ name, alias, id }: ModalFormUniversityProps) => {
    const [openModal, setOpenModal] = useState<boolean>(false);

    const { post, put, data, setData, errors, processing, clearErrors, reset } = useForm<ModalFormUniversityProps>({
        name,
        alias,
        id,
    });
    ...
    const onSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        id === null
            ...
            : put(route('#university.update', { id }), {
                  preserveState: true,
                  onSuccess: () => {
                      setOpenModal(false);
                  },
